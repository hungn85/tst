...
/* _widget_popup.html */
class __TwigTemplate_fdb7d0388070908d7f2bb1d99909030a82569a8826b540ac1959cc423b9ebaf7 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<!--_widget_popup.html-->
<!-- Element to pop up -->
\t\t\t\t\t\t<div  class=\"container demo_widget box_xs\" id=\"widget_popup\">
\t\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t\t\t<div class=\"col-md-12\">
\t\t\t\t\t\t\t\t\t<h4>Đặt xe</h4>
\t\t\t\t\t\t\t\t\t<hr/>
